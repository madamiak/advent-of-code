...
public class Puzzle4_1Test {
	...
	public void shouldReturn123() {
		assertThat(Puzzle4_1.solve("aaaaa-bbb-z-y-x-123[abxyz]")).isEqualTo(123);
	}

	@Test
	public void shouldReturn987() {
		assertThat(Puzzle4_1.solve("a-b-c-d-e-f-g-h-987[abcde]")).isEqualTo(987);
	}

	@Test
	public void shouldReturn404() {
		assertThat(Puzzle4_1.solve("not-a-real-room-404[oarel]")).isEqualTo(404);
	}

	@Test
	public void shouldReturn0() {
		assertThat(Puzzle4_1.solve("totally-real-room-200[decoy]")).isEqualTo(0);
	}

	@Test
	public void shouldReturnSum() {
		assertThat(Puzzle4_1.solve("aaaaa-bbb-z-y-x-123[abxyz]\n" +
				"totally-real-room-200[decoy]\n" +
				"a-b-c-d-e-f-g-h-987[abcde]")).isEqualTo(123 + 987);
	}

	@Test
	public void answer() {
		System.out.println(Puzzle4_1.solve("aczupnetwp-dnlgpyrpc-sfye-dstaatyr-561[patyc]\n" +
